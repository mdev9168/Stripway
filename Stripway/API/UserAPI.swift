...
class UserAPI {
    ...
    func updateUserInfo(forUser user: StripwayUser, newUsername: String?, newName: String?, newBio: String?, newBioLink: String?, newProfileImage: UIImage?, newHeaderImage: UIImage?, completion: @escaping ()->()) {
