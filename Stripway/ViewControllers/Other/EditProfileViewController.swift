...
class EditProfileViewController: UIViewController {
    ...
    func updateUserInfo(completion: @escaping ()->()) {
        ...
        API.User.updateUserInfo(forUser: profileOwner, newUsername: newUsername, newName: newName, newBio: newBio, newBioLink: newLink, newProfileImage: newProfileImage, newHeaderImage: newHeaderImage) {
            completion()
        }
    ...
    @IBAction func editInfoTabPressed(_ sender: Any) {
        self.currentTab = 1
    ...
    @IBAction func editStripsTabPressed(_ sender: Any) {
        self.currentTab = 2
