...
//    var profileOwnerUID: String?
    ...
    @IBOutlet weak var topTabOneButton: UIButton!
    @IBOutlet weak var topTabTwoButton: UIButton!
    ...
    func topTabChanged() {
        ...
        if currentTopTabSelected == 0 {
            topTabOneButton.titleLabel?.font = UIFont(name: "AvenirNext-Bold", size: 16)
            topTabOneButton.setTitleColor(.black, for: .normal)
            topTabTwoButton.titleLabel?.font = UIFont(name: "AvenirNext", size: 16)
            topTabTwoButton.setTitleColor(.darkGray, for: .normal)
            ...
            UIView.animate(withDuration: 0.3) {
                self.topTabsBackgroundView.layoutIfNeeded()
            }
        } else {
            topTabTwoButton.titleLabel?.font = UIFont(name: "AvenirNext-Bold", size: 16)
            topTabTwoButton.setTitleColor(.black, for: .normal)
            topTabOneButton.titleLabel?.font = UIFont(name: "AvenirNext", size: 16)
            topTabOneButton.setTitleColor(.darkGray, for: .normal)
...
//            }
    ...
    @IBOutlet weak var bigButtonTrailingConstraint: NSLayoutConstraint!
...
//        }
    ...
    func updateTopButtons() {
        if profileOwner != nil {
            ...
            if customTabBarController.futureSelectedIndex == 4 && self.navigationController?.viewControllers.count == 1 {
...
//            cell.showThumb = true
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if currentTopTabSelected == 1 {
            let ratio = reposts[indexPath.row].imageAspectRatio
