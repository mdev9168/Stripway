...
class SetPasswordViewController: UIViewController, UITextFieldDelegate {
    ...
    func setupTextView() {
        ...
        let tosURL = URL(string: "https://www.stripway.com/terms-of-use")
        let ppURL = URL(string: "https://www.stripway.com/privacy-policy")
    ...
    @IBAction func signUpButtonPressed(_ sender: Any) {
        ...
        if passwordIsFormattedCorrectly(password: passwordField.text!) {
            ...
            Auth.auth().createUserAndRetrieveData(withEmail: newUser.email, password: newUser.password) { (user, error) in
                if let error = error {
